...
const SPONSORS = [
  'Gemini Live', 'Tavus Phoenix-4', 'Cursor SDK', 'Daytona', 'Convex'
];

/* Mini workspace mockup used in the hero */
const HeroWorkspaceMock = () => (
  <div style={{
    width: '100%',
    aspectRatio: '16 / 10',
    borderRadius: 14,
    ...
    <div style={{ position: 'relative', minHeight: 0 }}>
      ...
      <div style={{
        ...
        <div className="glass-pill" style={{
          display: 'inline-flex', gap: 6, padding: '6px 8px',
          alignItems: 'center'
        }}>
          <div style={{
            width: 22, height: 22, borderRadius: 999, background: '#1a1a1a',
          ...
          }}><IconPhone size={10} style={{ transform: 'rotate(135deg)' }}/></div>
        </div>
      </div>
    </div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0,
      ...
      <div style={{
        ...
        padding: '0 12px', gap: 18,
        borderBottom: '1px solid var(--border-subtle)',
        fontSize: 11.5, color: 'var(--text-tertiary)',
        fontFamily: 'JetBrains Mono'
      }}>
        <span style={{ color: 'var(--accent-cyan)', borderBottom: '2px solid var(--accent-cyan)', paddingBottom: 8 }}>▶ Preview</span>
        <span>&lt;/&gt; Code</span>
        <span>· Insights</span>
        <div style={{ flex: 1 }}/>
        <span style={{ opacity: 0.7 }}>● ● ●</span>
      </div>
      <div style={{ flex: 1, padding: '14px 0', background: 'var(--bg-canvas)',
        fontFamily: 'JetBrains Mono', fontSize: 11, lineHeight: '18px' }}>
        {[
          ['1','import { useState } from ',['"react"',true]],
          ['2',''],
          ...
          <div key={i} style={{ display: 'flex', gap: 14, padding: '0 12px' }}>
            <span style={{ color: '#3F3F46', width: 16, textAlign: 'right' }}>{n}</span>
            <span style={{ color: '#A1A1AA', whiteSpace: 'pre' }}>{t}</span>
          </div>
        ))}
      </div>
    </div>
  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        <button className="btn btn-primary" onClick={onEnter}>Open Nexus</button>
      </nav>

      {/* HERO */}
      <section style={{
        position: 'relative', padding: '80px 64px 60px',
        ...
        <div style={{
          ...
          <div>
            <div style={{
              ...
              <span className="status-dot speaking" style={{ width: 6, height: 6 }}/>
            ...
            <h1 style={{
              ...
              is{' '}
              <span style={{
                background: 'linear-gradient(95deg, #00E5FF 0%, #B026FF 100%)',
            ...
            <p style={{
              ...
              maxWidth: 540, margin: '0 0 36px', textWrap: 'pretty',
            }}>
              Talk to Nexus. Watch it write, run, and ship full-stack apps in real time.
            </p>

            <div style={{ display: 'flex', gap: 12 }}>
              <button className="btn btn-primary lg" onClick={onEnter}>
                Start Building — Free
                <IconArrow size={14}/>
              </button>
            ...
            <div style={{
              ...
              marginTop: 36, color: 'var(--text-tertiary)',
              fontSize: 12,
            }}>
              <span>No credit card</span>
              <span style={{ width: 3, height: 3, background: 'currentColor', borderRadius: 999 }}/>
      ...
      <section id="features" style={{
        padding: '120px 64px 80px', maxWidth: 1320, margin: '0 auto', position: 'relative',
      }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          <div style={{
            fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase',
            color: 'var(--accent-cyan)', fontWeight: 500, marginBottom: 14,
          }}>The stack</div>
          <h2 style={{
            fontSize: 'clamp(32px, 3.2vw, 44px)', fontWeight: 600,
            letterSpacing: '-0.02em', margin: 0,
          }}>Everything that makes Nexus feel alive.</h2>
        </div>
        ...
        <div style={{
          ...
          {FEATURES.map((f, i) => (
            <div key={i} style={{
              padding: 28, background: 'var(--bg-surface)',
              border: '1px solid var(--border-subtle)',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            letterSpacing: '-0.03em', margin: '0 0 16px', textWrap: 'balance',
          }}>Stop typing. Start shipping.</h2>
          <p style={{
            fontSize: 17, color: 'var(--text-secondary)',
            margin: '0 0 36px',
          }}>Your first sandbox spins up in under 4 seconds.</p>
          <button className="btn btn-primary lg" onClick={onEnter}>
      ...
      <footer style={{
        ...
        <Logo size={18}/>
        <span style={{ marginLeft: 'auto' }}>© 2026 Nexus Labs · Built in San Francisco</span>
      </footer>
    </div>
  );
};
